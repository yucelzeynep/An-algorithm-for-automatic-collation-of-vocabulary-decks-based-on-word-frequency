...
For our specific example RBSC coeffiecint is found as 0.707, which suggest that the vocabulary in deck_A is used often used more frequenctly then the vocabulary in deck_B.
